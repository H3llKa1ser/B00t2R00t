# Taken from: https://github.com/beauknowstech/OSEP-Everything/blob/main/AMSI/shellcoderunner.ps1
...
# I got it to work better with windows/x64/meterpreter/reverse_https
