...
### 2) Encrypt shellcode with XOR and key 0xfa
...
### 3) Choose the type of exploit you need
...
### 4) Compile for Release & x64 (depending on your target architecture)
...
### 6) Depending on your choice of technique you may need to start a Python Server to server helper utilities (optional)
