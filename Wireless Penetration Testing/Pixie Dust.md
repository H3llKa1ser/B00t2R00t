...
Scan for the BSSID of the interface, then type a number to choose your target

    ./oneshot -i wlan0 -K 

Put all necessary credentials in one file

    wpa_passphrase AP_SSID 'WPA_PSK_PASSWORD' > psk 

    wpa_supplicant -B -c psk -i wlan0

Assign IP to interface. You may assign any IP you want to the specific interface
