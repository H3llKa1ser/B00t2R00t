...
## TIP: WHEN YOU WANT TO TRANSFER FILES AND SCRIPTS WITHIN AN ENTERPRISE NETWORK, ONLY USE PORTS 80 AND 443 BECAUSE FIREWALLS DENY TRAFFIC FROM OTHER PORTS BY DEFAULT
